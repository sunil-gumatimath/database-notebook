...
| **CURRENT_DATE()**                     | Same as `CURDATE()`                                                   | `SELECT CURRENT_DATE();`                                   | `2025-09-22`          |
...
| **CURRENT_TIMESTAMP()**                | Same as `NOW()`                                                       | `SELECT CURRENT_TIMESTAMP();`                              | `2025-09-22 23:15:30` |
| **ADDDATE(date, n)**                    | Adds `n` days to date                                                 | `SELECT ADDDATE('2025-09-22', 10);`                        | `2025-10-02`          |
| **DATE_ADD(date, INTERVAL expr unit)** | Adds interval to date                                                 | `SELECT DATE_ADD('2025-09-22', INTERVAL 3 MONTH);`         | `2025-12-22`          |
...
| **LAST_DAY(date)**                     | Returns last day of month                                             | `SELECT LAST_DAY('2025-09-22');`                           | `2025-09-30`          |
...
| **DATE_FORMAT(date, format)**          | Format date in custom way                                             | `SELECT DATE_FORMAT(NOW(), '%d-%M-%Y');`                   | `22-September-2025`   |
